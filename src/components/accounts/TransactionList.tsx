...
export function TransactionList({
  ...
  if (transactions.length === 0) {
    return (
      <div className="mt-2">
        <p className="text-xs text-foreground-muted">No transactions yet.</p>
        <button onClick={onAdd} className="mt-2 text-xs text-info hover:underline">+ Add transaction</button>
      </div>
    );
  }
  return (
